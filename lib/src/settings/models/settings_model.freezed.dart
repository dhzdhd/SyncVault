...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isSentryEnabled,  bool isHideOnStartup,  bool isLaunchOnStartup,  String? rClonePath,  String? rCloneConfigPath,  ThemeMode themeMode)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SettingsModel() when $default != null:
return $default(_that.isSentryEnabled,_that.isHideOnStartup,_that.isLaunchOnStartup,_that.rClonePath,_that.rCloneConfigPath,_that.themeMode);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isSentryEnabled,  bool isHideOnStartup,  bool isLaunchOnStartup,  String? rClonePath,  String? rCloneConfigPath,  ThemeMode themeMode)  $default,) {final _that = this;
switch (_that) {
case _SettingsModel():
return $default(_that.isSentryEnabled,_that.isHideOnStartup,_that.isLaunchOnStartup,_that.rClonePath,_that.rCloneConfigPath,_that.themeMode);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isSentryEnabled,  bool isHideOnStartup,  bool isLaunchOnStartup,  String? rClonePath,  String? rCloneConfigPath,  ThemeMode themeMode)?  $default,) {final _that = this;
switch (_that) {
case _SettingsModel() when $default != null:
return $default(_that.isSentryEnabled,_that.isHideOnStartup,_that.isLaunchOnStartup,_that.rClonePath,_that.rCloneConfigPath,_that.themeMode);case _:
  return null;
